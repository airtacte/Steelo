...
contract ConstDiamond is Initializable {
    ...
    function updatePreOrderCreatorRoyalty(
        uint256 _newRoyalty
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updatePreOrderSteeloRoyalty(
        uint256 _newRoyalty
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateLaunchCreatorRoyalty(
        uint256 _newRoyalty
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateLaunchSteeloRoyalty(
        uint256 _newRoyalty
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateLaunchCommunityRoyalty(
        uint256 _newRoyalty
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateSecondHandSellerRoyalty(
        uint256 _newRoyalty
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateSecondHandCreatorRoyalty(
        uint256 _newRoyalty
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateSecondHandSteeloRoyalty(
        uint256 _newRoyalty
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateSecondHandCommunityRoyalty(
        uint256 _newRoyalty
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateLiquidityProviders(
        address _newAddress
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
        require(
    ...
    function updateLiquidityProvidersMint(
        uint256 _newAmount
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateEcosystemProviders(
        address _newAddress
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
        require(
    ...
    function updateEcosystemProvidersMint(
        uint256 _newAmount
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
    ...
    function updateFoundersAddress(
        address _newAddress
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
        require(
    ...
    function updateEarlyInvestorsAddress(
        address _newAddress
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
        require(
    ...
    function updateEarlyInvestorsTGE(
        uint256 _newAmount
    ) external onlyAuthorized {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
