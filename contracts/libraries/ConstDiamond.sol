...
contract ConstDiamond {
    ...
    function initConstants() external {
        ...
        // ACCESS CONTROL
        ds.constants.ADMIN_ROLE = keccak256("ADMIN_ROLE");
        ds.constants.EMPLOYEE_ROLE = keccak256("EMPLOYEE_ROLE");
        ds.constants.TESTER_ROLE = keccak256("TESTER_ROLE");
        ds.constants.STAKER_ROLE = keccak256("STAKER_ROLE");
        ds.constants.USER_ROLE = keccak256("USER_ROLE");
        ds.constants.VISITOR_ROLE = keccak256("VISITOR_ROLE");
        ds.constants.CREATOR_ROLE = keccak256("CREATOR_ROLE");
        ds.constants.TEAM_ROLE = keccak256("TEAM_ROLE");
        ds.constants.MODERATOR_ROLE = keccak256("MODERATOR_ROLE");
        ds.constants.COLLABORATOR_ROLE = keccak256("COLLABORATOR_ROLE");
        ds.constants.INVESTOR_ROLE = keccak256("INVESTOR_ROLE");
        ds.constants.SUBSCRIBER_ROLE = keccak256("SUBSCRIBER_ROLE");
